      ...
      <div className="max-w-[1168px] mx-auto px-6 grid gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-[280px_1fr_280px] xl:grid-rows-[auto_1fr] xl:items-stretch">
        ...
        >
          ...
          <div className="flex justify-center gap-6 mb-6">
            <a href="https://linkedin.com/in/vakati-rutvij-reddy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white text-[#1f2937] flex items-center justify-center hover:bg-[#3b82f6] hover:text-white transition-colors">
